  ...
  return (
    ...
    >
      <div className={styles.Menu__arrowIcon__wrapper}>
        <motion.button
          className={`${styles.Toggle__button} ${isExpanded? stylesGlass.Glass__orange : stylesGlass.Glass__green}`}
        ...
        {isExpanded && (
          <>
            <div className={styles.Chat__wrapper}>
              <button
                className={`${styles.Button} ${showLayers ? stylesGlass.Glass__orange : stylesGlass.Glass__green}`}
              ...
              />
              <button className={`${styles.Button} ${stylesGlass.Glass__green}`}>
                <svg
                  className={styles.Button__icon}
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                >
                  <rect x="8" y="2" width="8" height="13" rx="4" stroke="#F3F3EF" strokeWidth="1.5"/>
                  <path d="M20 11.5C20 15.9183 16.4183 19.5 12 19.5C7.58172 19.5 4 15.9183 4 11.5" stroke="#F3F3EF" strokeWidth="1.5" strokeLinecap="round"/>
                  <path d="M12 22V20" stroke="#F3F3EF" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </button>
            </div>
            <AnimatePresence>
